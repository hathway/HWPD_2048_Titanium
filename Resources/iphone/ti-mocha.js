(function() {
    function require3(p) {
        var path = require3.resolve(p), mod = require3.modules[path];
        if (!mod) throw new Error('failed to require3 "' + p + '"');
        if (!mod.exports) {
            mod.exports = {};
            mod.call(mod.exports, mod, mod.exports, require3.relative(path));
        }
        return mod.exports;
    }
    function timeslice() {
    ...
    function createConsoleLogger(type) {
        console[type] = function() {
            var util = require3("titanium/util"), args = Array.prototype.slice.call(arguments, 0), rawArgs = args.slice(0), isStudio = /\-studio$/.test(mocha._ti_reporter);
            if (!mocha._ti_quiet) {
    ...
    require3.modules = {};
    require3.resolve = function(path) {
        var orig = path, reg = path + ".js", index = path + "/index.js";
        return require3.modules[reg] && reg || require3.modules[index] && index || orig;
    };
    require3.register = function(path, fn) {
        require3.modules[path] = fn;
    };
    require3.relative = function(parent) {
        return function(p) {
            if ("." != p.charAt(0)) return require3(p);
            ...
            return require3(path.join("/"));
        };
    };
    require3.register("sprintf-js", function(module, exports) {
        !function(a) {
            function b() {
            ...
            b.format = function(a, f) {
                ...
                for (h = 0; o > h; h++) if (p = c(a[h]), "string" === p) q[q.length] = a[h]; else if ("array" === p) {
                    if (j = a[h], j[2]) for (g = f[n], i = 0; j[2].length > i; i++) {
                    ...
                    (!r || e.number.test(j[8]) && j[3]) && (s = r ? "+" : "-", g = g.toString().replace(e.sign, "")), 
                    l = j[4] ? "0" == j[4] ? "0" : j[4].charAt(1) : " ", m = j[6] - (s + g).length, 
                    k = j[6] ? d(l, m) : "", q[q.length] = j[5] ? s + g + k : 0 == l ? s + k + g : k + s + g;
                }
                return q.join("");
            ...
            "undefined" != typeof exports ? (exports.sprintf = b, exports.vsprintf = f) : (a.sprintf = b, 
            a.vsprintf = f, "function" == typeof define && define.amd && define(function() {
                return {
                    sprintf: b,
                    vsprintf: f
                };
    ...
    require3.register("browser/debug.js", function(module) {
        module.exports = function() {
            return function() {};
        };
    });
    require3.register("browser/diff.js", function(module) {
        var JsDiff = function() {
    ...
    require3.register("browser/events.js", function(module, exports) {
    ...
    require3.register("browser/fs.js", function() {});
    require3.register("browser/path.js", function() {});
    require3.register("browser/progress.js", function(module) {
        function Progress() {
            this.percent = 0;
            this.size(0);
            this.fontSize(11);
    ...
    require3.register("browser/tty.js", function(module, exports) {
    ...
    require3.register("context.js", function(module) {
        function Context() {}
    ...
    require3.register("hook.js", function(module, exports, require3) {
        function Hook(title, fn) {
            Runnable.call(this, title, fn);
            this.type = "hook";
        }
        function F() {}
        var Runnable = require3("./runnable");
        module.exports = Hook;
    ...
    require3.register("interfaces/bdd.js", function(module, exports, require3) {
        var Suite = require3("../suite"), Test = require3("../test"), utils = require3("../utils");
        module.exports = function(suite) {
            var suites = [ suite ];
            suite.on("pre-require3", function(context, file, mocha) {
    ...
    require3.register("interfaces/exports.js", function(module, exports, require3) {
        var Suite = require3("../suite"), Test = require3("../test");
        module.exports = function(suite) {
            function visit(obj) {
                var suite;
            ...
            var suites = [ suite ];
            suite.on("require3", visit);
        };
    });
    require3.register("interfaces/index.js", function(module, exports, require3) {
        exports.bdd = require3("./bdd");
        exports.tdd = require3("./tdd");
        exports.qunit = require3("./qunit");
        exports.exports = require3("./exports");
    });
    require3.register("interfaces/qunit.js", function(module, exports, require3) {
        var Suite = require3("../suite"), Test = require3("../test"), utils = require3("../utils");
        module.exports = function(suite) {
            var suites = [ suite ];
            suite.on("pre-require3", function(context, file, mocha) {
    ...
    require3.register("interfaces/tdd.js", function(module, exports, require3) {
        var Suite = require3("../suite"), Test = require3("../test"), utils = require3("../utils");
        module.exports = function(suite) {
            var suites = [ suite ];
            suite.on("pre-require3", function(context, file, mocha) {
    ...
    require3.register("mocha.js", function(module, exports, require3) {
        function image(name) {
        ...
        function Mocha(options) {
            ...
            this.suite.on("pre-require3", function(context) {
        ...
        var path = require3("browser/path"), utils = require3("./utils");
        exports = module.exports = Mocha;
        exports.utils = utils;
        exports.interfaces = require3("./interfaces");
        exports.reporters = require3("./reporters");
        exports.Runnable = require3("./runnable");
        exports.Context = require3("./context");
        exports.Runner = require3("./runner");
        exports.Suite = require3("./suite");
        exports.Hook = require3("./hook");
        exports.Test = require3("./test");
        ...
        Mocha.prototype.reporter = function(reporter) {
            if ("function" == typeof reporter) this._reporter = reporter; else {
                ...
                var _reporter;
                try {
                    _reporter = require3("./reporters/" + reporter);
                } catch (err) {}
                if (!_reporter) try {
                    _reporter = require3(reporter);
                } catch (err) {}
        ...
        Mocha.prototype.loadFiles = function(fn) {
            ...
            this.files.forEach(function(file) {
                ...
                suite.emit("pre-require3", global, file, self);
                suite.emit("require3", require3(file), file, self);
                suite.emit("post-require3", global, file, self);
                --pending || fn && fn();
            });
        };
        Mocha.prototype._growl = function(runner, reporter) {
            var notify = require3("growl");
    ...
    require3.register("ms.js", function(module) {
        function parse(str) {
    ...
    require3.register("reporters/base.js", function(module, exports, require3) {
        ...
        var tty = require3("browser/tty"), diff = require3("browser/diff"), ms = require3("../ms"), utils = require3("../utils"), sprintf = require3("sprintf-js").sprintf;
        ...
        exports.list = function(failures) {
            ...
            failures.forEach(function(test, i) {
                ...
                console.error(sprintf(fmt, i + 1, test.fullTitle(), msg, stack));
            });
        };
        Base.prototype.epilogue = function() {
            ...
            console.log(sprintf(fmt, stats.passes || 0, ms(stats.duration)));
            if (stats.pending) {
                fmt = color("pending", " ") + color("pending", " %d pending");
                console.log(sprintf(fmt, stats.pending));
            }
            if (stats.failures) {
                fmt = color("fail", "  %d failing");
                console.error(sprintf(fmt, stats.failures));
    ...
    require3.register("reporters/doc.js", function(module, exports, require3) {
        function Doc(runner) {
            function indent() {
            ...
            runner.on("suite", function(suite) {
                ...
                ++indents;
                console.log(sprintf('%s<section class="suite">', indent()));
                ++indents;
                console.log(sprintf("%s<h1>%s</h1>", indent(), utils.escape(suite.title)));
                console.log(sprintf("%s<dl>", indent()));
            });
            runner.on("suite end", function(suite) {
                if (suite.root) return;
                console.log(sprintf("%s</dl>", indent()));
                --indents;
                console.log(sprintf("%s</section>", indent()));
                --indents;
            });
            runner.on("pass", function(test) {
                console.log(sprintf("%s  <dt>%s</dt>", indent(), utils.escape(test.title)));
                var code = utils.escape(utils.clean(test.fn.toString()));
                console.log(sprintf("%s  <dd><pre><code>%s</code></pre></dd>", indent(), code));
            });
        }
        var Base = require3("./base"), utils = require3("../utils"), sprintf = require3("sprintf-js").sprintf;
        exports = module.exports = Doc;
    });
    require3.register("reporters/dot.js", function(module, exports, require3) {
        function Dot(runner) {
            Base.call(this, runner);
        ...
        function F() {}
        var Base = require3("./base"), color = Base.color;
        exports = module.exports = Dot;
        F.prototype = Base.prototype;
        Dot.prototype = new F();
        Dot.prototype.constructor = Dot;
    });
    require3.register("reporters/html-cov.js", function(module, exports, require3) {
        function HTMLCov(runner) {
            var jade = require3("jade"), file = __dirname + "/templates/coverage.jade", str = fs.readFileSync(file, "utf8"), fn = jade.compile(str, {
                filename: file
            }), self = this;
        ...
        var JSONCov = require3("./json-cov"), fs = require3("browser/fs");
        exports = module.exports = HTMLCov;
    });
    require3.register("reporters/html.js", function(module, exports, require3) {
        ...
        var Base = require3("./base"), utils = require3("../utils"), Progress = require3("../browser/progress"), escape = utils.escape;
        var Date = global.Date;
        global.setTimeout, global.setInterval, global.clearTimeout, global.clearInterval;
    ...
    require3.register("reporters/index.js", function(module, exports, require3) {
        exports.Base = require3("./base");
        exports.Dot = require3("./dot");
        exports.Doc = require3("./doc");
        exports.TAP = require3("./tap");
        exports.JSON = require3("./json");
        exports.HTML = require3("./html");
        exports.List = require3("./list");
        exports.Min = require3("./min");
        exports.Spec = require3("./spec");
        exports.Nyan = require3("./nyan");
        exports.XUnit = require3("./xunit");
        exports.Markdown = require3("./markdown");
        exports.Progress = require3("./progress");
        exports.Landing = require3("./landing");
        exports.JSONCov = require3("./json-cov");
        exports.HTMLCov = require3("./html-cov");
        exports.JSONStream = require3("./json-stream");
    });
    require3.register("reporters/json-cov.js", function(module, exports, require3) {
        ...
        var Base = require3("./base");
        exports = module.exports = JSONCov;
    });
    require3.register("reporters/json-stream.js", function(module, exports, require3) {
    ...
    require3.register("reporters/json.js", function(module, exports, require3) {
    ...
    require3.register("reporters/landing.js", function(module, exports, require3) {
        ...
        function F() {}
        var Base = require3("./base"), cursor = Base.cursor, color = Base.color;
    ...
    require3.register("reporters/list.js", function(module, exports, require3) {
        function List(runner) {
            Base.call(this, runner);
            ...
            runner.on("pending", function(test) {
                ...
                console.log(sprintf(fmt, test.fullTitle()));
            });
            runner.on("pass", function(test) {
                var fmt = color("checkmark", "  " + Base.symbols.dot) + color("pass", " %s: ") + color(test.speed, "%dms");
                cursor.CR();
                console.log(sprintf(fmt, test.fullTitle(), test.duration));
            });
            runner.on("fail", function(test) {
                cursor.CR();
                console.log(sprintf(color("fail", "  %d) %s"), ++n, test.fullTitle()));
            });
            runner.on("end", self.epilogue.bind(self));
        }
        function F() {}
        var Base = require3("./base"), cursor = Base.cursor, color = Base.color, sprintf = require3("sprintf-js").sprintf;
        exports = module.exports = List;
        F.prototype = Base.prototype;
        List.prototype = new F();
        List.prototype.constructor = List;
    });
    require3.register("reporters/markdown.js", function(module, exports, require3) {
        ...
        var Base = require3("./base"), utils = require3("../utils");
        exports = module.exports = Markdown;
    });
    require3.register("reporters/min.js", function(module, exports, require3) {
        function Min(runner) {
            Base.call(this, runner);
            runner.on("start", function() {
    ...
    require3.register("reporters/nyan.js", function(module, exports, require3) {
    ...
    require3.register("reporters/progress.js", function(module, exports, require3) {
    ...
    require3.register("reporters/spec.js", function(module, exports, require3) {
        function Spec(runner) {
            ...
            runner.on("suite", function(suite) {
                ++indents;
                console.log(sprintf(color("suite", "%s%s"), indent(), suite.title));
            });
            runner.on("suite end", function() {
                --indents;
            ...
            runner.on("pending", function(test) {
                ...
                console.log(sprintf(fmt, test.title));
            });
            runner.on("pass", function(test) {
                if ("fast" == test.speed) {
                    ...
                    cursor.CR();
                    console.log(sprintf(fmt, test.title, test.duration));
                }
            });
            runner.on("fail", function(test) {
                cursor.CR();
                console.log(sprintf(indent() + color("fail", "  %d) %s"), ++n, test.title));
            });
            runner.on("end", self.epilogue.bind(self));
        }
        function F() {}
    ...
    require3.register("reporters/tap.js", function(module, exports, require3) {
        function TAP(runner) {
            Base.call(this, runner);
            var n = (this.stats, 1), passes = 0, failures = 0;
            runner.on("start", function() {
                var total = runner.grepTotal(runner.suite);
                console.log(sprintf("%d..%d", 1, total));
            });
            runner.on("test end", function() {
                ++n;
            });
            runner.on("pending", function(test) {
                console.log(sprintf("ok %d %s # SKIP -", n, title(test)));
            });
            runner.on("pass", function(test) {
                passes++;
                console.log(sprintf("ok %d %s", n, title(test)));
            });
            runner.on("fail", function(test, err) {
                failures++;
                console.log(sprintf("not ok %d %s", n, title(test)));
        ...
        var Base = require3("./base"), sprintf = (Base.cursor, Base.color, require3("sprintf-js").sprintf);
        exports = module.exports = TAP;
    });
    require3.register("reporters/xunit.js", function(module, exports, require3) {
        ...
        var Base = require3("./base"), utils = require3("../utils"), escape = utils.escape;
        var Date = global.Date;
        global.setTimeout, global.setInterval, global.clearTimeout, global.clearInterval;
    ...
    require3.register("runnable.js", function(module, exports, require3) {
        ...
        function F() {}
        var EventEmitter = require3("browser/events").EventEmitter, debug = require3("browser/debug")("mocha:runnable"), milliseconds = require3("./ms");
    ...
    require3.register("runner.js", function(module, exports, require3) {
        ...
        var EventEmitter = require3("browser/events").EventEmitter, debug = require3("browser/debug")("mocha:runner"), utils = (require3("./test"), 
        require3("./utils")), filter = utils.filter;
        utils.keys;
    ...
    require3.register("suite.js", function(module, exports, require3) {
        ...
        function F() {}
        var EventEmitter = require3("browser/events").EventEmitter, debug = require3("browser/debug")("mocha:suite"), milliseconds = require3("./ms"), utils = require3("./utils"), Hook = require3("./hook");
    ...
    require3.register("test.js", function(module, exports, require3) {
    ...
    require3.register("utils.js", function(module, exports, require3) {
        ...
        var fs = require3("browser/fs"), path = require3("browser/path"), join = path.join, debug = require3("browser/debug")("mocha:watch");
    ...
    var Mocha = global.Mocha = require3("mocha"), mocha = global.mocha = new Mocha({
        reporter: "html"
    });
    mocha.suite.removeAllListeners("pre-require3");
    ...
    mocha.ui = function(ui) {
        ...
        this.suite.emit("pre-require3", global, null, this);
        return this;
    };
    ...
    require3.register("reporters/ti-json.js", function(module, exports, require3) {
        ...
        var Base = require3("./base"), cursor = require3("titanium/util").cursor;
        Base.color;
        exports = module.exports = TiJSONReporter;
    });
    require3.register("reporters/ti-spec-studio.js", function(module, exports, require3) {
    ...
    require3.register("reporters/ti-spec.js", function(module, exports, require3) {
        ...
        function F() {}
        var Base = require3("./base"), cursor = require3("titanium/util").cursor, color = Base.color;
        exports = module.exports = TiSpec;
        F.prototype = Base.prototype;
        TiSpec.prototype = new F();
        TiSpec.prototype.constructor = TiSpec;
    });
    require3.register("titanium/util.js", function(module, exports) {
